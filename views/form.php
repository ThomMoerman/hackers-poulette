<form class="w-full max-w-lg m-auto" method="POST" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="contactForm" novalidate>
  ...
  <div>
        <div class="g-recaptcha mb-8 flex justify-center items-center" data-sitekey="6LfRT70mAAAAAA1hylaRIxMWfdiJRtU8UT5oMFmB">
        </div>
